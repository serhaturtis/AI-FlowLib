...
class VideoContentModel(ModelConfig):
    ...
    path: str = "/home/swr/tools/models/my_biz/my_models/phi-4-Q5_K_M.gguf"
    model_type: str = "phi4"
    n_ctx: int = 8192
    n_threads: int = 12
    n_batch: int = 512
...
#    path: str = "/home/swr/tools/models/my_biz/my_models/qwen2.5-coder-32b-instruct-q2_k.gguf"
#    model_type: str = "chatml"
#    n_ctx: int = 8192  # Large context for handling complex flow designs
#    n_threads: int = 12
#    n_batch: int = 512
#    use_gpu: bool = True
#    n_gpu_layers: int = -1
